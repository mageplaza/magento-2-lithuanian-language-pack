## Magento 2 Lithuanian Language Pack
...
2. [Install Lithuanian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Lithuanian language pack](#3-how-to-active-hungarian-language-pack)
...
![language pack](http://progressed.io/bar/11?title=translated)
...
```
unzip master.zip app/i18n/Mageplaza/lt_lt
```
...
## 3. How to active Lithuanian language pack {#active}
